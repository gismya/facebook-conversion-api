...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FacebookConversionsApiForWeb.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://graph.facebook.com/v8.0
     */
    this.basePath = 'https://graph.facebook.com/v8.0'.replace(/\/+$/, '');
