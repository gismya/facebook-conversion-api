...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResponseError', function() {
      beforeEach(function() {
        instance = new FacebookConversionsApiForWeb.ResponseError();
      });

      it('should create an instance of ResponseError', function() {
        // TODO: update the code to test ResponseError
        expect(instance).to.be.a(FacebookConversionsApiForWeb.ResponseError);
      });
